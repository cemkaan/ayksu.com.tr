jQuery(document).ready(function ($) {
    ...
    if ($('#nav-menu-container').length) {
        ...
        $(document).on('click', '#mobile-nav-toggle', function (e) {
            ...
            $('#mobile-nav-toggle i').toggleClass('ion-close-round ion-navicon');
    ...
    var urunIsotope = $('.urun-container').isotope({
        itemSelector: '.urun-item',
        layoutMode: 'fitRows'
    });

    $('#urun-flters li').on('click', function () {
        $("#urun-flters li").removeClass('filter-active');
